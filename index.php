...
<body>
    ...
    <header class="l-header" id="header">
        <nav class="nav bd-container">
            <a href="#" class="nav__logo">Koreanfo0d</a>
        ...
        <section class="home" id="home">
            <div class="home__container bd-container bd-grid">
                <div class="home__data">
                    <h1 class="home__title">Korean fo0d!</h1>
                    <h2 class="home__subtitle">Try the best food of <br>jinjja '맛있다'!</h2>
        ...
        <section class="about section bd-container" id="about">
            <div class="about__container  bd-grid">
                <div class="about__data">
                    ...
                    <h2 class="section-title about__initial">We cook the best <br> Korean food</h2>
                    <p class="about__description">We cook the best food in the entire city, with excellent customer service, Korean cuisine is largely based on rice, vegetables, seafood and meats.</br> visit us.</p>
                    <a href="#contact" class="button">Explore contact</a>
                </div>
        ...
        <section class="menu section bd-container" id="menu">
            ...
            <div class="menu__container bd-grid">
                <div class="menu__content">
                    ...
                    <h3 class="menu__name">Jajangmyeon</h3>
                    <span class="menu__detail">jinjja 맛있다!</span>
                    <span class="menu__preci">Rp 45.000,00</span>
                    <!--<a href="#buy" class="button menu__button" data-toggle="modal" data-target="#buy"><i class='bx bx-cart-alt'></i></a>-->
                </div>

                <div class="menu__content">
                    <img src="img/plate4.jpeg" alt="" class="menu__img">
                    <h3 class="menu__name">Tteokbokki </h3>
                    <span class="menu__detail">jinjja 맛있다!</span>
                    <span class="menu__preci">Rp 41.000,00</span>
                    <!--<a href="#buy" class="button menu__button" data-toggle="modal" data-target="#buy"><i class='bx bx-cart-alt'></i></a>-->
                </div>

                <div class="menu__content">
                    <img src="img/plate5.png" alt="" class="menu__img">
                    <h3 class="menu__name">Kimbap</h3>
                    <span class="menu__detail">jinjja 맛있다!</span>
                    <span class="menu__preci">Rp 37.000,00</span>
                    <!--<a href="#buy" class="button menu__button" data-toggle="modal" data-target="#buy"><i class='bx bx-cart-alt'></i></a>-->
                </div>
            </div>
            </br>
            ...
            <div class="menu__content">
                <center>
                    <h3 class="menu__name">Form to buy</h3>
                    <span class="menu__detail">Click Here!</span>

                    <div class="contact__button">
                        <a href="buy.php" class="button" data-toggle="modal" data-target="#buy"><i class='bx bx-cart-alt'></i> Buy</a>
                    </div>
                </center>
            </div>
    ...
    <footer class="footer section bd-container">
        <div class="footer__container bd-grid">
            <div class="footer__content">
                <a href="#" class="footer__logo">Korean Fo0d</a>
            ...
            <div class="footer__content">
                ...
                <ul>
                    ...
                    <li>999 - 888 - 777</li>
                    <li>Kfo0d@gmail.com</li>
                </ul>
            </div>
        </div>

        <p class="footer__copy">&#169; 2020. All right reserved </br>Syafirli Pindaningtyas</p>
    </footer>
